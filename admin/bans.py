...
#         return
#     await callback.message.edit_text("Введи ID користувача для бану:")
...
#         await callback.answer("⛔ Тільки адміністратор.", show_alert=True)
#         return
#     await callback.message.edit_text("Введи ID користувача для розбану (тільки цифри):")
...
#     await callback.message.answer(text, parse_mode="HTML", reply_markup=main_menu(is_admin=True))
