...
def champion_main_kb() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [KeyboardButton(text="💵 Добавити на Champion")],
...
def matic_main_kb() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [KeyboardButton(text="💵 Добавити на Matic")],
...
@router.message(F.text == "💵 Добавити на Champion")
...
@router.message(F.text == "💵 Добавити на Matic")
