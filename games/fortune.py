...
from handlers.config import ADMIN_ID  # ← додали ADMIN_ID
from db import (
...
async def fortune_start(message: Message):
    ...
    await message.answer(
        ...
        f"🔹 У тебе <b>🎟️</b> : <code>{promo}</code> \n"
        f"🔹 Один оберт коштує <b>{FORTUNE_COST} 🎟️</b>\n\n"
        f"🔸 Крути і вигравай реальні гроші до депозиту!\n"
        f"🔸 Або Бездеп якщо ви грали протягом 24 годин! 💰",
