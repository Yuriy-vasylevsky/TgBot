...
CARD_NUMBER = """А банк : 4323347389002806
Приват : 5169 3600 2817 8204
Кредо : 5355 1770 4847 4148

Мінімальний платіж 100 грн
Мінімальний вивід 200 грн
...
Потопи 💥 ворожий корабель 💥
 та отримай  до 2️⃣0️⃣0️⃣0️⃣ грн винагороди.

Правила

1️⃣ Потрібно обрати сектор на полі та вказати його у групі.
2️⃣ Якщо ви попали, можна зробити наступний постріл.
3️⃣ За кожен програний дерозит у розмірі 1️⃣0️⃣0️⃣ грн дається одна спроба. На день не більше 7 спроб.

❗️Виграшні гроші не рахуються❗️
"""
...
LINK1 = """   💵💵💵 Чемпіон💵💵💵
  ...
  Щоб зайти в гру введіть код тут - https://chcwhite.net
