...
#     stats = (
#         await get_all_stats()
#     )  # сюди входить "Один з трьох" (він зберігається у game_results)
...
#     # Підрахунок глобальної статистики по СЕСІЯХ
#     total_sessions = 0
#     total_wins = 0

#     # 🎯 "Один з трьох" (беремо з get_all_stats)
#     total_guess = 0
#     wins_guess = 0
...
#     total_sessions += total_guess
#     total_sessions += total_slots
#     total_sessions += total_blackjack

#     total_wins += wins_guess
#     total_wins += wins_slots
#     total_wins += wins_blackjack
...
#     # --- 🌍 Глобальна статистика по всіх сесіях ---
#     if total_sessions > 0:
#         global_rate = total_wins / total_sessions * 100
#         text += (
#             "🌍 <b>Глобальна статистика</b>\n"
#             f"🔹 Усього зіграних сесій: <b>{total_sessions}</b>\n"
